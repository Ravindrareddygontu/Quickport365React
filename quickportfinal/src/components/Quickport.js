  ...
  return (
    ...
    <div className='area1' >
      ...
      <div className="ButtonContainer text-center">
        <button className='btn btn-danger me-5 mt-2 mb-2' onClick={pending}>Pending</button>
        <button className='btn btn-secondary me-5 mt-2 mb-2' onClick={picked}>Picked</button>
        <button className='btn btn-primary me-5 mt-2 mb-2' onClick={process}>Process</button>
        <button className='btn btn-success mt-2 mb-2' onClick={completed}>Completed</button>
      </div>
